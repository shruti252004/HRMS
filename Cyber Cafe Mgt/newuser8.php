...
<body>
    ...
    <div class="content">
        <div class="glass">
            ...
            $specific_username = 'Sonam Takiya'; // Change this to the actual username

            // Prepare and bind
            $stmt = $conn->prepare("SELECT ID, EntryID, username, useraddr, mobile_number, email, computer_name, IDproof, intime, out_time, fees, remark, status, updation_date FROM newusers WHERE username = ?");
